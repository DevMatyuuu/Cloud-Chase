...
function Hero() {
  return (
    <section className='md:mb-[100px] mb-14 md:pt-[28px] sl:md:pt-[47px] lg:md:pt-[47px] pt-5 sm:pt-10 font-poppins'>
     <div className='container mx-auto md:max-w-[1480px] lg:max-w-[1600px]'>
        ...
        <div className='flex flex-col sl: gap-y-[30px] w-full max-w-xs sm:max-w-lg sl:max-w-lg md:max-w-[1500px] h-[600px] bg-primary md:m-auto sl:m-auto sm:m-auto mx-auto '>
            ...
            <Link to={`https://cloud-chase.vercel.app/products/3`}>
                <div className='flex flex-col md:hover:duration-300 md:hover:scale-105 md:ml-3 sm:ml-8 md:mt-0 mt-5'>
                 ...
                 <p className='text-sm font-bold max-w-[100px] text-black px-2 py-2 bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 rounded-xl text-center uppercase md:ml-1'>shop now</p>
