...
function Icon({ id, open }) {
  return (
    <svg
      ...
      strokeWidth={2}
      stroke="currentColor"
      className={`${id === open ? "rotate-180" : ""} ml-3 h-5 w-5 transition-transform`}
    >
...
export function Faqs() {
  ...
  return (
    <>
    <div className='container mx-auto md:max-w-[1200px] rounded-xl md:px-auto text-white text-justify  bg-gradient-to-b from-gray-900 to-gray-600 px-7 pb-16 mb-10 md:pl-20 md:pr-20 md:pt-5 font-poppins'>
        <h1 className='font-poppins md:text-3xl text-2xl  md:mb-9 mb-7 pt-9 font-bold text-center'>FAQs</h1>
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(1)} className="md:mb-5 sl:mb-5 mb-2 text-sm sm:text-xl lg:text-2xl justify-center">Comparison between Vape and Cigarette?</AccordionHeader>
                <AccordionBody className='md:mb-5 sl:mb-5 mb-5 text-sm'>
            ...
            <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(2)} className="md:mb-5 sl:mb-5 mb-2 text-sm sm:text-xl lg:text-2xl justify-center">
            ...
            <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(3)} className="text-sm sm:text-xl lg:text-2xl justify-center" >
                Can I return products and get a refund if unsatisfied?
                </AccordionHeader>
                <AccordionBody className='md:mt-5 sl:mt-5 mt-2 text-sm'>
