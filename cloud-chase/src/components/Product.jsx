...
function Product({product}) {
  return (
    <Link to={`/products/${product.id}`}>
        <div className='grad bg-gradient-to-b from-gray-900 to-gray-600 w-full md:h-[300px] md:max-w-[300px] max-w-[200px] sm:h-[300px] sl:h-[280px] rounded-[8px] overflow-hidden relative group justify-center'>
            ...
            <div className='absolute bg-amber-400 text-black text-[10px] font-bold uppercase top-3 right-4 px-2 rounded-lg'>New</div>
                ...
                <div className='md:w-full md:h-[180px] sm:w-[full] sm:h-[180px] flex items-center justify-center md:mt-0 sl:mt-5 sm:mt-0 mt-5'>
                     <img src={`http://localhost:1337${product.attributes.image.data.attributes.url}`} className='sm-md:w-[160px] sm-md:h-[160px] h-[120px] group-hover:scale-90 transition-all'/>
                </div>
