...
function Product({product}) {
  ...
  return (
    ...
    <Link to={`/product/${product.id}`}>
        <div className='grad bg-gradient-to-b from-gray-900 to-gray-600 w-full md:h-[320px] md:max-w-[300px] max-w-[200px] sm:h-[300px] sl:h-[240px] h-[250px] rounded-[8px] overflow-hidden relative group mx-auto justify-center shadow-xl'>
        <div>
            ...
            <div className='absolute bg-amber-400 text-black text-[10px] font-bold uppercase top-3 right-4 px-2 rounded-lg'>New</div>
                ...
                <div className='md:w-full md:h-[180px] sm:w-[full] sm:h-[180px] flex items-center justify-center md:mt-0 sl:mt-5 sm:mt-0 mt-5'>
                     <img src={`https://cloud-chase-web.onrender.com${product.attributes.image.data.attributes.url}`} className='sm:w-[100px] md:h-[120px] h-[80px] sl:h-20 sl:mb-0 md:mt-5 sm:mt-0 sl:mt-5 mt-8 group-hover:scale-105 transition-all'/>
                </div>
                <div className='md:mb-5 md:ml-5 md:mt-0 sl:mt-0  text-white p-2 sl:ml-4'>
                    ...
                    {product.attributes.isSale ? (
                     ...
                     ) : (<div className='absolute text-yellow-500 text-sm font-bold uppercase sl:left-6 sl:bottom-4 md:left-5 left-2 md:bottom-6 bottom-2 px-2 rounded-lg '>
                     ₱{origPrice}
                 </div>)}
                    </div>
