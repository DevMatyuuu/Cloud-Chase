...
function ProductDetails() {
  ...
  const {data} = useFetch(`/products?populate=*&filters[id][$eq]=${id}`)
    if (!data) {
      return <div className="text-white mx-auto md:w-36 md:font-bold md:text-2xl md:mt-36 ml-[140px] mt-32 w-32 pb-[200px] md:ml-[750px] md:pb-[252px]"><Lottie animationData={loading}/></div>
    }
