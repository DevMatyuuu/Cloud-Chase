      ...
      <div className='container mx-auto w-auto bg-gradient-to-b from-gray-900 to-gray-600 md:pb-20 md:mt-10 rounded-2xl max-w-[1300px] md:mb-20'>
        <div className='md:flex flex-row text-center md:gap-5 md:ml-32'>
          ...
          <div className='flex'>
            ...
            <Button onClick={() => addToCart(data, id)} className='bg-yellow-500 hover:bg-yellow-700 hover:text-white md:py-4 py-2 md:px-4 px-2 md:ml-5 md:text-md text-xs mt-3 text-black font-extrabold rounded-lg uppercase'>Add to cart</Button>
          </div>
          </div>
        </div>
