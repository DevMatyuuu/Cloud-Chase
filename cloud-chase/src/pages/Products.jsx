    ...
    <div className='mb-10 pt-0 md:pb-[100px] sl:mb-60 sm:pt-0 font-poppins'>
      <div className='container mx-auto'>
        <main>
          ...
          {isLoading ? (
            // Show loading state
            <span className="text-white mx-auto md:w-36 md:font-bold md:text-2xl md:mt-20 ml-32 mt-20 w-32 pb-[150px] md:ml-[650px] md:pb-24"><Lottie animationData={loading}/></span>
              ) : data && data.length > 0 ? (
               data?.map((product) => (
              <motion.div
                key={product.id}
