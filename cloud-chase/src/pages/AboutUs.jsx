...
function AboutUs() {
  return (
    <>
    <div>
        <div className='container mx-auto md:max-w-[1200px] rounded-xl md:px-auto text-white text-justify  bg-gradient-to-b from-gray-900 to-gray-600 px-7 pb-16 mb-10 md:pl-20 md:pr-20'>
