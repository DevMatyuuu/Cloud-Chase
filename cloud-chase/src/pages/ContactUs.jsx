...
function ContactUs() {
  ...
  return (
    <section className='text-white'>
        <div className="py-8 lg:py-16 z-0 px-6 mx-auto md:max-w-[1000px] sl:max-w-[1000px] sm:max-w-[600px] md:mt-10 sl:mt-5 sm:mt-5 sm:mb-5 mt-5 mb-5 sl:mb-5 md:mb-10 rounded-xl bg-gradient-to-b from-gray-900 to-gray-600">
            ...
            <form action="#" className="space-y-8">
                ...
                <Button onClick={handleOpenModal} type="submit" className="py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-white sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</Button>
            </form>
        </div>
        <Modal
        isOpen={modalOpen}
